package com.inga.utils.page;


import com.inga.bean.Form;
...
public class PageInterceptor implements Interceptor {
    ...
    private static String Target = "target"; //代理目标类
    private static String H = "h"; //代理目标类
    private static String MetaParameters = "metaParameters"; //sql参数
...
//                Form page = (Form) metaStatementHandler
//                        .getValue("delegate.boundSql.parameterObject.parameter");
                Form page = (Form) boundSql.getParameterObject();
...
//            page.setTotalCount(totalCount);
     ...
     * @return
     */
    private String buildPageSql(String sql, Form page) {
        if (page != null) {
     ...
     * @return String
     */
    public StringBuilder buildPageSqlForMysql(String sql, Form page) {
     ...
     * @return String
     */
    public StringBuilder buildPageSqlForOracle(String sql, Form page) {
        StringBuilder pageSql = new StringBuilder(100);
        String beginrow = String.valueOf((page.getPage() - 1) * page.getLimit());
